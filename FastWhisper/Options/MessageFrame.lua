...
local frame = addon.templates.CreateFrame("FastWhisperMessageFrame", addon.frame)
...
local list = CreateFrame("ScrollingMessageFrame", "FastWhisperScrollingMessageFrame", frame, "ChatFrameTemplate")
